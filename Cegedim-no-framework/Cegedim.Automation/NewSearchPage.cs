...
//		private Lazy<SelectGroup> m_organizationSelectGroup;
		...
		public NewSearchPage(IApp application) {
			app = application;
		}
...
//		}
//
		public NewCallPage NavigateToCallPage() {
			string callCustomersResults = ((iOSApp)app).NewSelectCallCustomers(2);
			JArray callCustomers = JArray.Parse(callCustomersResults);
			NewCallPage.CallCustomers = callCustomers;
			return new NewCallPage (app);
